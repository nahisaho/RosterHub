...
**Primary Pattern**: モノレポ + モジュラーモノリス

> npm workspacesを使用したモノレポ構造で、バックエンドAPIはNestJSのモジュラーモノリスパターンを採用。
...
│   │   ├── src/
│   │   │   ├── oneroster/   # OneRosterドメイン
│   │   │   │   ├── entities/    # エンティティモジュール
│   │   │   │   ├── api/         # REST API
│   │   │   │   ├── csv/         # CSV処理
│   │   │   │   ├── auth/        # 認証
│   │   │   │   ├── audit/       # 監査ログ
...
├── docs/                    # ドキュメント
│   ├── design/              # 設計ドキュメント
│   ├── implementation/      # 実装ステータス
│   ├── requirements/        # 要件仕様
│   └── guides/              # 開発者ガイド
├── design/                  # データベース設計
│   └── database/            # DDL, ERD, Prismaスキーマ
├── steering/                # プロジェクトメモリー
